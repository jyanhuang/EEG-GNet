...
class zhnn(nn.Module):
    def __init__(self, input_shape, A):
        ...
        self.RLU11 = nn.ELU(inplace=True)
        self.drop11 = nn.Dropout2d(0.25)

        self.gconv2 = GCN_layer((60, 384), bias=True)
        ...
        self.gconv4 = GCN_layer((60, 96), bias=True)
        ...
        self.dconv6 = nn.Conv2d(16, 16, kernel_size=(30, 1), stride=(1, 1), groups=16)
